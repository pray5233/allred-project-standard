...
$required = @(
  ...
  'tests\runtime-dialogues.json',
  'tests\runtime-review.schema.json',
  'tests\ordered-review.schema.json',
  'tests\runtime-evidence-migrations.json',
  'scripts\run_runtime_dialogues.ps1',
  'scripts\eval_runtime.ps1',
  'scripts\check_eval_runtime.ps1',
  'scripts\ordered_review.ps1',
  'scripts\check_ordered_review.ps1',
  'scripts\check_runtime_review_pipeline.ps1',
  'scripts\check_native_sessions.ps1',
  'scripts\run_ordered_review.ps1',
  'scripts\check_runtime_evidence_migration.ps1',
