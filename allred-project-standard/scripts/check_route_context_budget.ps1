...
$limits = @(
  @{ route = 'new-beginner-public'; stage = 'intake'; maxLines = 300; maxCharacters = 16500 },
  @{ route = 'new-beginner-public'; stage = 'evidence'; maxLines = 500; maxCharacters = 32500 },
  @{ route = 'new-beginner-public'; stage = 'decision'; maxLines = 580; maxCharacters = 44500 },
