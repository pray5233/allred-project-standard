...
当前 GitHub 预发布候选版本：`0.8.0-rc13`。稳定版本仍为 `0.7.1`；安装目录中的 `VERSION` 和安装回执用于确认实验机实际加载的版本、提交与哈希。
...
稳定版本应使用与 `VERSION` 一致的 Git tag；当前稳定 tag 为 `v0.7.1`，最新 GitHub 预发布 tag 为 `v0.8.0-rc13`。`rc13` 用于实验机和真实项目继续验收，不替代 `v0.7.1` 稳定版。
